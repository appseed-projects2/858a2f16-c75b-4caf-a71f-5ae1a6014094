...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-08 20:05`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/858a2f16-c75b-4caf-a71f-5ae1a6014094.git
$ cd 858a2f16-c75b-4caf-a71f-5ae1a6014094
```
